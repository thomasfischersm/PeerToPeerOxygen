 ...
 * taught successfully.
 */
public class ReportMissionCheckoutCompleteAction extends ClientAction {

    private static final String LOG_CAT = ReportMissionCheckoutCompleteAction.class.getSimpleName();

    private final Long studentId;
    private final Long buddyId;
    private final Long missionId;

    public ReportMissionCheckoutCompleteAction(

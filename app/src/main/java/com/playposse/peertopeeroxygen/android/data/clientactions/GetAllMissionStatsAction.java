 ...
 */
public class GetAllMissionStatsAction extends ClientAction {

    private static final String LOG_CAT = GetAllMissionStatsAction.class.getSimpleName();

    private final Callback callback;

    private List<MissionStatsBean> missionStatsBeanList;

    public GetAllMissionStatsAction(BinderForActions binder, Callback callback) {
        super(binder, false);
